...
@media(max-width:1000px){
  body.showMobileMenu .sidebar, body.showMobileMenu .side{display:block!important;position:fixed!important;top:0!important;right:0!important;width:82%!important;max-width:320px!important;height:100vh!important;z-index:9999!important;border-radius:0!important;overflow:auto!important;}
  body.showMobileMenu:before{content:"";position:fixed;inset:0;background:rgba(0,0,0,.45);z-index:9998;}
  .mobile-title{display:flex!important;align-items:center;justify-content:space-between;gap:10px;}
  .mobile-title:before{content:"☰";display:grid;place-items:center;width:46px;height:46px;background:#fff;border-radius:16px;box-shadow:0 8px 20px rgba(55,30,15,.08);font-size:22px;}
  .mobile-title{cursor:pointer;}
}
@media(max-width:700px){
  #ordersTable, #ordersTable thead, #ordersTable tbody, #ordersTable th, #ordersTable td, #ordersTable tr{display:block!important;min-width:0!important;width:100%!important;}
  #ordersTable thead{display:none!important;}
  #ordersTable tr{background:#fff;margin:12px 0;border-radius:18px;box-shadow:0 8px 22px rgba(55,30,15,.08);overflow:hidden;padding:12px;}
  #ordersTable td{border:0!important;padding:8px 10px!important;text-align:right!important;}
  #ordersTable td:nth-child(1)::before{content:"رقم الطلب: ";font-weight:900;color:#5a2d15;}
  #ordersTable td:nth-child(2)::before{content:"الطاولة: ";font-weight:900;color:#5a2d15;}
  #ordersTable td:nth-child(3)::before{content:"الوقت: ";font-weight:900;color:#5a2d15;}
  #ordersTable td:nth-child(4)::before{content:"العناصر: ";font-weight:900;color:#5a2d15;}
  #ordersTable td:nth-child(5)::before{content:"الإجمالي: ";font-weight:900;color:#5a2d15;}
  #ordersTable td:nth-child(6)::before{content:"الحالة: ";font-weight:900;color:#5a2d15;}
  .actions{display:grid!important;grid-template-columns:1fr!important;}
  .actions .btn{text-align:center!important;}
}
</style>
</head><body>
<div class="mobile-top"><button class="mobile-btn" onclick="document.body.classList.toggle('showMobileMenu')">☰</button><h1>كافيه فرفشة ☕</h1><button class="mobile-btn" onclick="document.getElementById('cartBox').scrollIntoView({behavior:'smooth'})">🛒</button></div>
<div class="app">
...
</style></head><body><div class="box"><div class="logo">☕</div><h1>كافيه فرفشة</h1><p>تسجيل دخول المدير</p>{% if error %}<div class="error">{{ error }}</div>{% endif %}<form method="POST"><input type="password" name="pin" placeholder="ادخل كود المدير"><button type="submit">دخول لوحة التحكم</button></form></div></body></html>
'''
