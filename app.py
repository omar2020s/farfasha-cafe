...
function setCartOpen(isOpen){const list=document.getElementById('cartList');const btn=document.getElementById('cartToggleBtn');if(isOpen){list.classList.add('open');if(btn)btn.innerText='إخفاء السلة';}else{list.classList.remove('open');if(btn)btn.innerText='عرض السلة';}}
